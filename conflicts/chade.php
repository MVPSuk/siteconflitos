    ...
    <main id="main">
      ...
      <br>
       <ul>
          ...
          <li>Extensão territorial: 1.284.000 quilômetros quadrados
</li>
          ...
          <li>Governo: república presidencialista sob regime militar
</li>
          <li>Idioma: francês e árabe
</li>
          <li>Religiões:
54% (islamismo);
34% (cristianismo);
12% (outras).
         ...
         <li>População: 16.430.000 habitantes
</li>
<li>Densidade demográfica: 8,7 habitantes/quilômetro quadrado
</li>
<li>Índice de Desenvolvimento Humano (IDH): 0,398 (baixo)
</li>
<li>Moeda: Franco CFA
</li>
<li>Produto Interno Bruto (PIB): US$ 10,09 bilhões
</li>
<li>PIB per capita: US$ 614
</li>
<li>Gini: 43%
</li>
<li>Fuso horário: UTC+1
</li>
<li>Relações exteriores:
Organização das Nações Unidas (ONU);
União Africana (UA).
</li>
<li>Divisão administrativa: 22 regiões administrativas, sendo elas:
</li>
      </ul>
      <br>
       <table border="1px">
      <tbody>
       ...
       <img src="../imgs/img2chade.png" alt="img2chade">
      <br>
     ...
     <li>Insatisfação doméstica na Líbia;
</li>
     <li>Bombardeio estadunidense à Benghazi e Trípoli em abril de 1986;</li>
     <li>Equipamento pesado do exército líbio, o que deixou as tropas mais lentas.
</li>
 </ul>
...
<h2>Vídeos</h2>
<br>
<a href="https://youtu.be/Gwv51C8okOg">Lago Chade: mais de um milhão de pessoas deixam suas casas enquanto crise se aprofunda
Presidente do Chade morre após conflito contra rebeldes
</a>
      <br><br><h3>Referências:</h3><br>
      
  <p> <a     
href="https://www.preparaenem.com/geografia/chade.htm

"> https://www.preparaenem.com/geografia/chade.htm

</a> </p>
<p><a href="https://professormarcianodantas.blogspot.com/2014/04/conflitos-no-chade-e-na-republica.html
